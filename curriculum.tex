...
%-----       resume       ---------------------------------------------------------
\makecvtitle
\small{Data scientist with 6+ years of experience, currently working in the R\&D department of Edison SPA in Milan.

My job is to identify potential opportunities for data driven solutions within the company, collect requirements, perform cost-benefit analysis, develop and deploy the machine learning model using python and cloud technologies.
...
My role allows me to build and maintain relationships with innovative startups and with the academia (our HQ of is located inside the PoliHub, the startup incubator managed by the Polytechnic of Milan) and, consequently, to be always up to date with the latest data science tools, techniques and best practices.

Also a large amount of my free time is dedicated to AI: I am one of the four ambassador of ODSC in Milan and, since the beginning of 2020, I am partner of \emph{Fatti di Algos}, a think-thank about the impact of AI in the society.}
...
\item{\cventry{Jun 2015 -- Jun 2017}{Gas Portfolio Management}{Quan (Pricing \& Option Structuring)}{ENI}{}{}
