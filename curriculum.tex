...
%-----       resume       ---------------------------------------------------------
\makecvtitle
\small{Data science and ML professional with 7 years of experience, currently working in the P\&C Solutions - Advanced Analytics team of Swiss Re in Milan.

I have experience in project management tools and tecniques, expecially within the agile framework (KANBAN and SCRUM), in facing stakeholders of any technical background, in collecting requirements, provide time \& cost estimates and in the management of teams of junior data scientists on a project basis.

After a ML model is put in production, I take care of the design of controlled experiments to estimate the economic benefits of its adoption for the company, mainly through AB testing.

I have experience in almost any field of data science, from time series forecasting to optimization, from NLP to computer vision, from stochastic calculus to numerical optimization.

I work mainly with python, using git for versioning and docker/kubernetes for the industrialization. I have experience both with the AWS and the Azure ecosystem.

My role allows me to build and maintain relationships with innovative startups and with the academia and, consequently, to be always up to date with the latest data science tools, techniques and best practices.}

\section{Experience}

\begin{itemize}
\item{\cventry{Feb 2022 -- present}{P\&C Solutions - Advanced Analytics}{Senior Data Scientist}{Swiss Re}{}{}
The team I am part of provides internal R\&D services for other Swiss Re business units. 
\smallskip
\begin{itemize}
\item{\emph{Vehicle Testing} -> a model to predict the performance of ADAS system on newest cars from the results of track tests}
\end{itemize} 
\smallskip
}
\item{\cventry{Jul 2017 -- Jan 2022}{Research, Developement \& Innovation}{Senior Data Scientist}{Edison}{}{}
The team I am part of act as a sort of internal consultancy team for any corporate area who wants to implement a machine learning solution in its business. Hereafter some of the main projects I've worked on:
\smallskip
\begin{itemize}
