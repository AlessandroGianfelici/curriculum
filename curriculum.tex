...
In my role I take care of the whole life cycle of the digital product: requirements and data collection, algorithm design, coding, presentation to technical and non-technical audiences, deployment and KPI monitoring. 

I have a deep knowledge of machine learning (both in its theoretical aspects and in its applications to industry use cases), software engineering skills and experience in supervising small teams of junior colleagues. 
...
I dedicate a large amount of my free time to AI: I am one of the four ambassador of ODSC in Milan and, since the beginning of 2020, I joined \emph{Fatti di Algos}, a think-thank about the impact of AI in the industry, sponsored by the hedge fund Euklid.}

\section{Experience}

\begin{itemize}
\item{\cventry{Aug 2018 -- present}{Research, Developement \& Innovation}{Data Scientist}{Edison}{}{}
The team I am part of act as sort of "internal consultancy" team for any corporate area who wants to implement machine learning solutions in its business. In my job I interact with technical and non-technical stakeholders, I design the solution and I take care of the implementation, sometimes (in biggest project) supervising the work of a small team (1 or 2) junior data scientist.
\smallskip
Hereafter some of the project I was involved in:
\begin{itemize}
...
\end{itemize} 
\smallskip
All our project are developed according to the Agile manifesto, using the Scrum methodology. 
\smallskip
...
Option pricing and development of forecasting models. Tech stack: Python, Matlab, VBA}
\end{itemize}
...
\begin{itemize}
 \item ODSC: organization of data science events in Milan and review of the content of the Machine Learning Certificate
